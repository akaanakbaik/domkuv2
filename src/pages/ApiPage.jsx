...
const ApiPage = ({ user }) => {
  ...
  "method": "POST",
  "url": "${currentUrl || 'https://domku.my.id'}/api/subdomain",
  "headers": {
  ...
  const curlCommand = `curl -X POST "${currentUrl || 'https://domku.my.id'}/api/subdomain" -H "Authorization: Bearer YOUR_API_KEY" -H "Content-Type: application/json" -d '{"name":"subdomain_anda","type":"A","content":"165.232.166.128"}'`;
