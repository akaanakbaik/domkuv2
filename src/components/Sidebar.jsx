...
const Sidebar = ({ show, setShow, user }) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-3 right-3 w-[75vw] sm:w-[45vw] lg:w-[28vw] max-w-md max-h-[55vh] bg-dark-800/85 border border-dark-700 rounded-2xl z-50 transform transition-transform duration-300 ease-in-out sidebar overflow-hidden ${
