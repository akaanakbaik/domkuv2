...
const Sidebar = ({ show, setShow, user }) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-4 right-4 w-[60vw] sm:w-[45vw] lg:w-[28vw] max-w-sm max-h-[50vh] bg-dark-800/85 border border-dark-700 rounded-2xl z-50 transform transition-transform duration-300 ease-in-out sidebar overflow-hidden ${
