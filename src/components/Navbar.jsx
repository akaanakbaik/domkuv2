  ...
  return (
    <nav className="fixed top-0 left-0 right-0 h-16 bg-surface/80 backdrop-blur border-b border-stroke flex items-center justify-between px-4 z-50">
      ...
      <div className="hidden md:flex items-center gap-2 text-sm">
        <button onClick={() => navigate('/')} className="px-3 py-2 rounded-lg border border-stroke text-foreground">Home</button>
        <button onClick={() => navigate('/subdomain')} className="px-3 py-2 rounded-lg border border-stroke text-foreground">Subdomain</button>
        <button onClick={() => navigate('/api')} className="px-3 py-2 rounded-lg border border-stroke text-foreground">API</button>
        <button onClick={() => navigate('/developer')} className="px-3 py-2 rounded-lg border border-stroke text-foreground">Developer</button>
      </div>
